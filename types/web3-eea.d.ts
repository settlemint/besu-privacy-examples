...
export default class EEAClient extends Web3 {
  ...
  priv: {
    ...
    deletePrivacyGroup: (options: {
      privacyGroupId: string;
    }) => Promise<string>;
    findPrivacyGroup: (options: {
      addresses: string[];
  ...
  privx: {
    ...
    findOnChainPrivacyGroup: (options: {
      addresses: string[];
    }) => Promise<PrivacyGroup>;
    removeFromPrivacyGroup: (options: {
      privacyGroupId: string;
      privateKey: string;
      enclaveKey: string;
      participant: string;
    }) => Promise<PrivateTransactionReceipt>;
    addToPrivacyGroup: (options: {
      privacyGroupId: string;
      privateKey: string;
      enclaveKey: string;
      participants: string[];
    }) => Promise<PrivateTransactionReceipt>;
    setPrivacyGroupLockState: (options: {
      privacyGroupId: string;
      privateKey: string;
      enclaveKey: string;
      lock: boolean;
...
declare class PrivateSubscription extends EventEmitter {
  ...
  on(
    eventName: string,
    callback: (error: unknown, result: PrivateLog) => void
  ): this;
